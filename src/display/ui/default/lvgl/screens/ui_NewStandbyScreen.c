...
void ui_NewStandbyScreen_screen_init(void) {
    ...
    lv_obj_set_size(icon_container, 200, 64);
    ...
    // WiFi icon — LVGL symbol, crisp at any size
    ui_NewStandbyScreen_wifiIcon = lv_label_create(icon_container);
    ...
    // Bluetooth icon
    ui_NewStandbyScreen_btIcon = lv_label_create(icon_container);
