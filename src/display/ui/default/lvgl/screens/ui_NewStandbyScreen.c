...
void ui_NewStandbyScreen_screen_init(void) {
    ...
    lv_obj_set_style_bg_color(ui_NewStandbyScreen, lv_color_black(), LV_PART_MAIN);
    ...
    lv_obj_set_style_text_color(ui_NewStandbyScreen_wifiIcon, lv_color_white(), LV_PART_MAIN);
    ...
    lv_obj_set_style_text_color(ui_NewStandbyScreen_btIcon, lv_color_make(128, 128, 128), LV_PART_MAIN);
}
